...
public class ProductServiceImpl implements com.acbcwy.spring.product.service.ProductService {
    ...
    public ProductServiceImpl(){
    	productMap.put("1", new Product("1","苹果手机-02",2,9999.0));
    	productMap.put("2", new Product("2","小米手机-02",10,5999.0));
    	productMap.put("3", new Product("3","美的空调-02",5,3999.0));
    	productMap.put("4", new Product("4","特斯拉汽车-02",1,309999.0));
